...
<template>
  <section class="mx-auto w-full max-w-7xl px-4 py-8 sm:py-10">
    ...
    <div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <aside class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-zinc-900 p-4 sm:p-5 shadow-lg shadow-slate-200/50 dark:shadow-black/20 transition-colors">
        <h2 class="text-lg font-semibold text-violet-600 dark:text-cyan-300 transition-colors">Estadísticas en tiempo real</h2>
        <div class="mt-4 space-y-3">
          ...
          <div class="rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 transition-colors">
            <p class="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Tiempo</p>
            <p class="text-xl font-bold text-slate-800 dark:text-white">00:00</p>
          </div>
        </div>
      </aside>
    </div>
